/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker/worker-configuration.d.ts` (hash: efb27ee228e8a1d970f5d3f53c0df6f8)
// Runtime types generated with workerd@1.20260921.1 2026-09-01
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	OG_DYNAMIC: "on";
	VITE_APPLE_DEVELOPER_TOKEN: string;
	VITE_APPLE_DEVELOPER_TOKEN_EXP: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OG_DYNAMIC" | "VITE_APPLE_DEVELOPER_TOKEN" | "VITE_APPLE_DEVELOPER_TOKEN_EXP">> {}
}
